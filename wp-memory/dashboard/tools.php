...
echo '<br>';
echo '<big>';
esc_attr_e("If you need support, please, copy and paste the info below in our", "wp-memory"); ?>
&nbsp;
<a href="https://BillMinozzi.com/support"><?php esc_attr_e("Support Site", "wp-memory"); ?></a>
<br><br>
<?php
wp_memory_sysinfo_display();
echo '</big>';
echo '</div>';
function wp_memory_sysinfo_display()
{
	if (! current_user_can('activate_plugins')) {
		//	return;
	}
?>
	<textarea style="height:100vh;width:100%" readonly="readonly" onclick="this.focus(); this.select()"><?php echo wp_memory_sysinfo_get(); ?></textarea>
<?php
}
